<template>
    <div class="progress-bar full-width margin-top-small">
        <div
            class="progress-bar-success-line"
            v-bind:style="{ width: successPortionPercentage + '%' }"
        ></div>
        <div
...
export default Vue.extend({
    ...
    computed: {
        successPortionPercentage: function () {
